...
const payment = async (req, res, next) => {
  ...
  Order.findByPk(external_reference, {
    ...
    .then((order) => {
      ...
      order
        ...
        .then((_) => {
          ...
          return res.redirect(
            process.env.NODE_ENV === 'production'
              ? 'https://e-commerce-labs-frontend-jonathanruizsilva.vercel.app/home'
        ...
        .catch((err) => {
          ...
          return res.redirect(
            process.env.NODE_ENV === 'production'
              ? `https://e-commerce-labs-frontend-jonathanruizsilva.vercel.app/?error=${err}&where=al+salvar`
    ...
    .catch((err) => {
      ...
      return res.redirect(
        process.env.NODE_ENV === 'production'
          ? `https://e-commerce-labs-frontend-jonathanruizsilva.vercel.app/?error=${err}&where=al+buscar`
